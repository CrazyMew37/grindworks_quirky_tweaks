...
const MOD_DIR := "CrazyMew37-BetterHauntedGolfCourse" # Name of the directory that this file is in
const LOG_NAME := "CrazyMew37-BetterHauntedGolfCourse:Main" # Full ID of the mod (AuthorName-ModName)
...
func install_script_extensions() -> void:
	...
	ModLoaderMod.install_script_extension(extensions_dir_path.path_join("scenes/game_floor/floor_modifiers/scripts/anomalies/floor_mod_power_out.gd"))
