...
const MOD_DIR := "CrazyMew37-MercyRestart" # Name of the directory that this file is in
const LOG_NAME := "CrazyMew37-MercyRestart:Main" # Full ID of the mod (AuthorName-ModName)
