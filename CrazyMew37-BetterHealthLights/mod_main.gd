...
const MOD_DIR := "CrazyMew37-BetterHealthLights" # Name of the directory that this file is in
const LOG_NAME := "CrazyMew37-BetterHealthLights:Main" # Full ID of the mod (AuthorName-ModName)
