...
const MOD_DIR := "CrazyMew37-CogCreatorPlus" # Name of the directory that this file is in
const LOG_NAME := "CrazyMew37-CogCreatorPlus:Main" # Full ID of the mod (AuthorName-ModName)
