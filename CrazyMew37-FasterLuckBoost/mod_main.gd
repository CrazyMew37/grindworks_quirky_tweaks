...
const MOD_DIR := "CrazyMew37-FasterLuckBoost" # Name of the directory that this file is in
const LOG_NAME := "CrazyMew37-FasterLuckBoost:Main" # Full ID of the mod (AuthorName-ModName)
...
func install_script_hook_files() -> void:
	extensions_dir_path = mod_dir_path.path_join("extensions")
	ModLoaderMod.install_script_hooks("res://objects/battle/battle_resources/doodle_actions/doodle_playdead.gd", extensions_dir_path.path_join("objects/battle/battle_resources/doodle_actions/doodle_playdead.hooks.gd"))
